...
var Element = function () {
    function Element(elementName, buildYear) {
...
var Park = function (_Element) {
    ...
    function Park(elementName, buildYear, treeCount, parkArea) {
        _classCallCheck(this, Park);

        var _this = _possibleConstructorReturn(this, (Park.__proto__ || Object.getPrototypeOf(Park)).call(this, elementName, buildYear));

        _this.treeCount = treeCount;
    ...
    _createClass(Park, [{
        ...
        value: function treeDensity() {
            var density = this.treeCount / this.parkArea;
...
var Street = function (_Element2) {
    ...
    function Street(elementName, buildYear, length) {
        var size = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 3;

        _classCallCheck(this, Street);

        var _this2 = _possibleConstructorReturn(this, (Street.__proto__ || Object.getPrototypeOf(Street)).call(this, elementName, buildYear));
...
var parkList = [new Park('Green Park', 1800, 25000, 10000), new Park('Hyde Park', 1950, 100, 50), new Park('Milnerton Park', 1900, 2000, 1000)];

var streetList = [new Street('Mimosa', 1950, 1000), new Street('Graaf', 1900, 2000, 5), new Street('N7', 1800, 50000, 5), new Street('Jasmin', 1960, 200, 2)];
...
function calc(arr) {
    ...
    var sum = arr.reduce(function (prev, cur, index) {
        return prev + cur;
    }, 0); //0 to start with our sum at zero; prev=0 at the beginning
...
function reportParks(p) {
    ...
    var ages = p.map(function (element) {
    ...
    var ix = p.map(function (element) {
        return element.treeCount;
...
function reportStreets(s) {
    ...
    var _calc3 = calc(s.map(function (element) {
